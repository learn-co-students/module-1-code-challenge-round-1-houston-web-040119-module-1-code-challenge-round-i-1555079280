...
class Customer
  ...
  def add_review(restaurant,content,rating)
    # given a **restaurant object**, some review content (as a string), and a star rating (as an integer), creates a
    # new review and associates it with that customer and restaurant.
    Review.new(self,restaurant,rating,content)
  end

  def reviews
    # returns an array of all reviews authored by the customer
